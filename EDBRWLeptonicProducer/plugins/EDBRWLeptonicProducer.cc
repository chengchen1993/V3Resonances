// -*- C++ -*-
//
// Package:    V3Resonances/EDBRWLeptonicProducer
// Class:      EDBRWLeptonicProducer
// 
/**\class EDBRWLeptonicProducer EDBRWLeptonicProducer.cc V3Resonances/EDBRWLeptonicProducer/plugins/EDBRWLeptonicProducer.cc
