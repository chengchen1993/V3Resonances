...
process.load("V3Resonances.EDBRGenStudies.genMuons_cff")
process.load("V3Resonances.EDBRGenStudies.genElectrons_cff")
process.load("V3Resonances.EDBRGenStudies.selectLeptonicDecay")
process.load("V3Resonances.EDBRGenStudies.selectHadronicDecay")
...
process.p2 = cms.Path(process.leptonicDecay 
                      ...
                      + process.printTree)
process.load("V3Resonances.EDBRCommon.simulation.RSGravToZZ_kMpl01_M-4500")
#process.load("V3Resonances.EDBRCommon.simulation.DYJetsToLL_HT-600toInf")
